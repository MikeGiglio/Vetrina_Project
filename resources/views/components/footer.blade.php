    ...
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <a href="/" class="flex items-center gap-2">
                <img src="/images/logo.png" alt="My House Logo" style="width:28px;height:28px;object-fit:contain;">
                <span style="font-family:'Playfair Display',serif;font-size:0.95rem;font-weight:700;letter-spacing:0.15em;color:rgba(240,245,241,0.45);">MY HOUSE</span>
            </a>
        ...
        <div class="text-center" style="margin-top:2rem;">
            ...
            <div style="font-family:'DM Sans',sans-serif;font-size:0.68rem;color:rgba(255,255,255,0.25);letter-spacing:0.06em;">
                &copy; {{ date('Y') }} My House 44 &middot; {{ __('footer.rights') }}
            </div>
        </div>
    </div>
</footer>
